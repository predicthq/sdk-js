...
class Events extends BaseEndpoint {
    ...
    constructor(client, accountId){
        ...
        this.arrayOptions = ['category', 'sort', 'top_events.sort', 'rank_level', 'label', 'country','place.scope','place.exact', 'external_id']
    ...
    countExternal(options){
        ...
        if (validate.valid) {
            return this.get('v1', '/events/count-external/', EventCountResult, options)
        }
